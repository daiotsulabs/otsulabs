...
export default function JoinUs({ join }: { join: any }) {
  ...
  return (
    <Center className="w-full h-full px-[20px] animate-page-fade">
      <Container
        maxWidth={"1200"}
        className="h-full md:h-auto pt-[80px] md:pt-0 px-0"
      >
        <Flex
          color="#707070"
          className="wrap-content flex-col md:flex-row items-start justify-between"
          gap={isMobileScreen ? "44px" : 244}
        >
          <Box flex="1">
            <Heading
            ...
            <Text
              ...
              mt={5}
            >
              Where being weeby is a way of life. Step into a culture that
              thrives on creativity, innovation, and passion.
            </Text>
            <ul className="mt-8">
              {jobs.map((job) => (
                <li
                ...
                >
                  <Link href={`/careers/${job.slug}`}>
                    ...
                    >
                      <Text
                        fontWeight={400}
                        className="leading-[normal] text-xs md:text-base 2xl:text-xl"
                      >
                        {job.name}
                      </Text>
                      <ArrowRightIcon
          ...
          >
            ...
            >
              Don&apos;t worry! Join our freelancer network and collaborate with
              us on a project basis.
            </Text>
            <Text
              className="text-xs md:text-base 2xl:text-xl leading-[normal]"
              my={isMobileScreen ? 2 : 3}
            >
              ...
              storyboard artists, concept artists, and character designers to
            ...
            <Text
              className={`${mcQueenDisplay.className} text-xl 2xl:text-2xl text-white mt-2`}
            >
