  ...
  return (
    <Layout>
      ...
      <Center className="w-full h-full bg-black animate-page-fade">
        <Container
          maxWidth={540}
          className="h-full px-6 md:px-auto md:h-auto pt-20 md:pt-0"
        >
          <Box
            className="text-md md:text-[28px] text-[#f5f5f5] font-bold uppercase"
          ...
          {isMobileScreen && (
            <Box color="#707070" className="text-xs" maxWidth={284} mb={8}>
              Got an idea? Reach out to us and let&apos;s get started. From
              concept to creation, we&apos;re here to guide you.
            </Box>
          )}
          <Box flex="1" className="pb-8">
            ...
            {isSubmitted && (
              <Text
                ...
                fontWeight={400}
              >
                Thanks for getting in touch! Your message is delivered and we
                will do our best to reply to you soon.
              </Text>
            )}
          </Box>
        </Container>
